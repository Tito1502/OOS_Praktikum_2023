...
public class PrivateBank implements Bank {
    ...
    public void createAccount(String account) throws AccountAlreadyExistsException {
        ...
        //persistiert account mit Transaktionen bei der Erstellung
    ...
    /***
     * gibt alle Account Namen als Liste zurück
     *
     * @return Namen aller Accounts
     */
    ...
    /***
     * löscht einen Account mit allen dazu gehörigen Transaktionen
     *
    ...
    public void deleteAccount(String account) throws AccountDoesNotExistException, IOException
    {
        ...
        //löscht account.json file
        File file = new File(this.directoryName + "\\Konto " + account + ".json");
        file.delete();
    }
}
