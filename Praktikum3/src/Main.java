...
public class Main {
    public static void main(String[] args) throws AccountAlreadyExistsException, TransactionAlreadyExistException, AccountDoesNotExistException, TransactionAttributeException, TransactionDoesNotExistException, TransferPaymentAttributeException {
        ...
        PrivateBank bank1 = new PrivateBank("Bank1", 0.1, 0.5);
        PrivateBank bank2 = new PrivateBank("Bank1", 0.2, 0.8);
        try {
        ...
        try {
            PrivateBank bank = new PrivateBank("Bank1", 2, 0.5);
        } catch (Exception e) {
            e.printStackTrace();
        }

        try {
            PrivateBank bank = new PrivateBank("Bank1", 0.5, 2);
        } catch (Exception e) {
            e.printStackTrace();
        }
